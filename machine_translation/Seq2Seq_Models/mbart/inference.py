...
def save_results(translations, references, metric_scores, source_language, target_language, model_name):
    ...
    output_file = f"mbart_{source_language}_{target_language}_translations.csv"
...
for target_language in languages:
    ...
    folder_path = f'mbart-large-50-finetuned-{language_map[source_language]}-to-{language_map[target_language]}'
