...
# Load datasets
data = DatasetDict()
data = load_dataset(args.dataset, args.source_language, cache_dir='/home/tdtuyen/.cache/huggingface/datasets')
...
def preprocess_function(examples):               
    ...
    decoder_input_ids = shift_tokens_right(
        ...
        tokenizer.lang_code_to_id[args.target_lang_symbol]  
    )
...
model_args = Seq2SeqTrainingArguments(
    f"{name_model}-finetuned-{args.source_lang_symbol}-to-{args.target_lang_symbol}",
